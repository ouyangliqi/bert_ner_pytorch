#!/bin/bash
MODEL_PATH_A=checkpoints/merge_clean_v2_seed12345/pretrain-model.torch
MODEL_PATH_B=checkpoints/merge_clean_v2_seed12345/finetune-model.torch
DATASET=datasets
CUDA_VISIBLE_DEVICES=2 python bin/main.py \
    ...
    --do_train \
    --do_test \
    --trainset  $DATASET/merge_clean_v2_raw_data_sent/train_data_raw.json \
    --evalset $DATASET/merge_clean_v2_raw_data_sent/val_data_raw.json \
    --testset $DATASET/merge_clean_v2_raw_data_sent/test_data_raw.json \
