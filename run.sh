#!/bin/bash
MODEL_PATH_A=checkpoints/noisy_data_3_seed12345/pretrain-model.torch
MODEL_PATH_B=checkpoints/noisy_data_3_seed12345/finetune-model.torch
DATASET=datasets
...
#    --do_train \
#    --do_test \
#    --trainset  $DATASET/noisy_data_3/train_data_raw.json \
#    --evalset $DATASET/noisy_data_3/test_data_raw.json \
#    --testset $DATASET/noisy_data_3/test_data_raw.json \
...
CUDA_VISIBLE_DEVICES=2 python bin/main.py \
    ...
    --bert_load_mode from_pretrained \
    --model_save_path checkpoints/baseline_appen_not_filter_equal_sampling_seed12345.torch